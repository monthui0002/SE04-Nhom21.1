...
public class RemediumRunOrder extends RemediumObject {

	private static final byte[] TYPE_DATA = new byte[] {ReceiveRemediumObjectState.RUN};
	...
	public RemediumRunOrder(int hostID, int referenceID, String methodName, List<RemediumObject> arguments) {
		this.hostID = hostID;
