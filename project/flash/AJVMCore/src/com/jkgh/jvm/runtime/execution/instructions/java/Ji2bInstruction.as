package com.jkgh.jvm.runtime.execution.instructions.java {
	...
	import com.jkgh.jvm.runtime.NumberHelper;
	...
	public class Ji2bInstruction extends HavingNextInstruction {
	
		public function Ji2bInstruction(offset:int) {
			super(offset);
		}
