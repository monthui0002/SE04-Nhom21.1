package com.jkgh.jvm.runtime.execution.instructions.java {
	...
	public class JinvokespecialInstruction extends HavingNextInstruction {
	
		public function JinvokespecialInstruction(offset:int) {
			super(offset);
		}
		...
		override public function execute(frame:FrameExecutionContext):InstructionExecutionResult {
			...
			if (at == null) {
				...
				var method:JVMMethod = invocator.getOwnerClass().resolveSpecialMethod(invocator.getIdentity());
