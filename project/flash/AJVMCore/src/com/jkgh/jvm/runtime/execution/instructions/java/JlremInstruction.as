package com.jkgh.jvm.runtime.execution.instructions.java {
	...
	public class JlremInstruction extends HavingNextInstruction {
	
		public function JlremInstruction(offset:int) {
			super(offset);
		}
		...
		override public function execute(frame:FrameExecutionContext):InstructionExecutionResult {
			...
			frame.pushLong(new PrimitiveLong(a.divideAndRemainder(b)[1]));
