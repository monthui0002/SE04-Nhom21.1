package com.jkgh.jvm.runtime.execution.instructions.java {
	...
	public class JmonitorenterInstruction extends HavingNextInstruction {
	
		public function JmonitorenterInstruction(offset:int) {
			super(offset);
		}
		...
		override public function execute(frame:FrameExecutionContext):InstructionExecutionResult {
			...
			ref.enterMonitor(frame.getThread());
